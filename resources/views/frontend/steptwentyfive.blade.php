                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="py-2">                                                                   
                                                                    <div class="col-md-11 m-auto">
                                                                        ...
                                                                        <div class="row pb-1">
                                                                            <div class="col-sm-12">
                                                                                <h3> Video <i class="ft-info text-right s-20"></i></h3>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="selfystric gray-light videoself p-0">
                                   ...
                                   <div class="col-sm-12 ml-auto text-center m-0">
                                    ...
                                    <label class="col-sm-2 label-control"></label>
                                        ...
                                        <div class="row justify-content-center">                                                    
                                            <div class="col-md-8">
                                                <button type="submit" class="btn round btn-block btn-glow btn-bg-gradient-x-purple-blue col-sm-12 mb-1"> Preview </button>
