@include('frontend.registerheader')
     ...
     <section class="flexbox-container custom-flexbox-container">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-6 col-10 box-shadow-2 p-0 register-wrp register-step bankuploadaddress-wrp" style="">
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            ...
                            <div class="card-content">
                                <div class="card-body verify-user text-center">
                                   <div class="card">
                                       <div class="card-body">
                                            <form class="form-horizontal" action="{{route('stepseventeen')}}" novalidate>                                           
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="member-type py-2">                                                                   
                                                                    <div class="col-md-11 m-auto">
                                                                        ...
                                                                        <div class="row pb-1">
                                                                            <div class="col-sm-12">
                                                                                <h3>Upload Address Proofs <i class="ft-info text-right s-20"></i></h3>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select id="companyinput5" name="interested" class="form-control">
                                                                                        <option value="none" selected="" disabled="">Address Proof</option>
