                        ...
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            ...
                            <div class="card-content">
                                <div class="card-body verify-user text-center">
                                   <div class="card">
                                       <div class="card-body">
                                            <form class="form-horizontal" action="{{route('steptwentyfour')}}" novalidate>                                           
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="py-2">                                                                   
                                                                    <div class="col-md-11 m-auto">
                                                                        ...
                                                                        <div class="row pb-1">
                                                                            <div class="col-sm-12">
                                                                                <h3> Selfie <i class="ft-info text-right s-20"></i></h3>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="selfystric gray-light p-0">
                                                                                    <img style="max-width: 100%;" src="{{ url('assets/frontassets/register/app-assets/images/selfieimg.png')}}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
