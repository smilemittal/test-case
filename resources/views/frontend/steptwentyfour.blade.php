                        ...
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            ...
                            <div class="card-content">
                                <div class="card-body verify-user text-center">
                                   <div class="card">
                                       <div class="card-body">
                                            <form class="form-horizontal" action="{{route('steptwentyfive')}}" novalidate>                                           
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="member-type py-2">                                                                   
                                                                    <div class="col-md-11 m-auto">
                                                                        ...
                                                                        <div class="row pb-1">
                                                                            <div class="col-sm-12">
                                                                                <h3>Record Video <i class="ft-info text-right s-20"></i></h3>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="selfystric gray-light circalvideo">
                                                                                    <img src="{{ url('assets/frontassets/register/app-assets/images/ico/record.svg')}}">
                                                                                    
                                                                                </div>
                                                                                <h4 class="text-center py-1">Please record this message...</h4>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row text-center justify-content-center mt-2">
                                                                            <div class="col-sm-12">
                                                                                <p>
                                                                                    Hi, My Name is Vivek Tiwari<br> I would like to open Kannexa Membership
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row text-center justify-content-center mt-2">
