@include('frontend.registerheader')
     ...
     <section class="flexbox-container custom-flexbox-container">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-6 col-10 box-shadow-2 p-0 register-wrp register-step selectaddress-wrp" style="">
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            <div class="card-header border-0 p-0">
                                ...
                                <div class="font-medium-5  text-center py-0">
                                    Select address <i class="ft-info text-right"></i> 
                                </div>
                            </div>
                            <div class="card-content">
                                ...
                                <div class="card-body verify-user text-center">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="selectaddress-check text-left">
                                                <div class="custom-control custom-checkbox pb-1">
                                                    <input type="checkbox" class="custom-control-input" id="customCheck1">
                                                    <label class="custom-control-label" for="customCheck1">
                                                        Pippin Count, Apple Tree Gardens New Barnet, London
                                                    </label>
                                                </div>
                                                <div class="custom-control custom-checkbox pb-1">
                                          ...
                                          <a href="{{route('stepelveven')}}"><button type="button" class="btn round btn-block btn-glow btn-bg-gradient-x-purple-blue col-sm-12 mb-1">Next <i class="ft-arrow-right"></i></button></a>
