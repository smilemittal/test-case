                ...
                <ul class="nav navbar-nav mr-auto float-left">
                                ...
                                <div class="carousel slide pt-1" id="carousel-example" data-ride="carousel">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active"><img class="d-block w-100"
                                                                               src="{{ url('assets/dashboard/app-assets/images/carousel/08.jpg')}}"
                                                                               alt="First slide"></div>
                                        <div class="carousel-item"><img class="d-block w-100"
                                                                        src="{{ url('assets/dashboard/app-assets/images/carousel/03.jpg')}}"
                                                                        alt="Second slide"></div>
                                        <div class="carousel-item"><img class="d-block w-100"
                                                                        src="{{ url('assets/dashboard/app-assets/images/carousel/01.jpg')}}"
                                                                        alt="Third slide"></div>
                                    </div>
                    ...
                    <li class="dropdown d-none d-md-block mr-1"><a class="dropdown-toggle nav-link"
                        ...
                        <div class="dropdown-menu">
                            <div class="arrow_box"><a class="dropdown-item" href="#"><i class="ft-user"></i> Email</a><a
                                    class="dropdown-item" href="#"><i class="ft-mail"></i> Chat</a><a
                                    class="dropdown-item" href="#"><i class="ft-briefcase"></i> Project Summary</a><a
                                    class="dropdown-item" href="#"><i class="ft-calendar"></i> Calendar </a></div>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            <div class="arrow_box"><a class="dropdown-item" href="#"><i
                                        ...
                                        class="flag-icon flag-icon-cn"></i> Chinese</a><a class="dropdown-item"
                                                                                          href="#"><i
                                        class="flag-icon flag-icon-ru"></i> Russian</a><a class="dropdown-item"
                                                                                          href="#"><i
                                ...
                                <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img
                                                        src="{{ url('assets/dashboard/app-assets/images/portrait/small/avatar-s-6.png')}}"
                                                        alt="avatar"></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img
                                                        src="{{ url('assets/dashboard/app-assets/images/portrait/small/avatar-s-3.png')}}"
                                                        alt="avatar"></span></div>
                                            <div class="media-body">
